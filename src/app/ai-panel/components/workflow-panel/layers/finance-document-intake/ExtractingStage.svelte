<script lang="ts">
	...
	const PHASES = [
		'Reading the fields...',
		'Cross-checking with the document text...',
	...
	async function runFieldExtract() {
...
<div class="extract">
	{#if error}
		<div class="extract-error">
			...
			<div class="err-actions">
				<button type="button" class="btn-secondary" onclick={onBack}>â†?Back</button>
	...
	{:else}
		<div class="reading-card">
			...
			<div class="reading-phase" aria-live="polite">{PHASES[phaseIndex]}</div>
			<div class="progress-track" aria-hidden="true">
				<span class="progress-glow"></span>
			</div>
			<div class="reading-footnote">Category-aware extraction Â· usually under a second</div>
		</div>
	{/if}
</div>
...
<style>
	...
	.err-actions { display: inline-flex; gap: 10px; margin-top: 12px; }
	...
	.btn-secondary:hover { color: var(--panel-fg); border-color: var(--panel-gold); }
	.btn-primary {
		background: var(--panel-gold);
	...
	.btn-primary:hover { background: var(--panel-gold-bright); }
</style>
