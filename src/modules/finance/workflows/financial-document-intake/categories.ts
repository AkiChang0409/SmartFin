 ...
 *
 * Source of truth: ref_files/smartfin-expense-revenue-design.md ยง4.4 (expense
 * categories), ยง5.3 (revenue / invoice_out), ยง8 (archive: contract /
...
/** Document type label used by extraction (broader than ExpenseDocType โ€?adds invoice_out + archive types). */
...
export interface CategoryDefinition {
	...
	hasDocument: boolean;
	/** Persistence routing โ€?which DB table this category lands in. */
...
// ---------------------------------------------------------------------------
// Category catalog โ€?11 expense + 1 revenue + 3 archive
// ---------------------------------------------------------------------------
