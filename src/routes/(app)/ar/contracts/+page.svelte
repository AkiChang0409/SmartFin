...
<PageShell
	...
	description="Manage contract records across all projects. Filter by project and maintain amount/date metadata."
>
	{#if form?.message}
	...
	<form class="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-4" method="GET">
		...
		<a class="rounded border border-slate-300 px-3 py-2 text-center text-sm text-slate-700 hover:bg-slate-50" href="/ar/contracts">
			Reset
		</a>
	</form>
