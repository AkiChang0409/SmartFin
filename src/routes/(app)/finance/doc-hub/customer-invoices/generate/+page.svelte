	...
	async function generateAndSend() {
		...
		try {
			...
			const shouldSaveToProject = window.confirm(
				'Download finished. Save this PDF to the linked project?\n\nOK: upload to project storage and attach to this invoice.\nCancel: keep the local file only; you can upload manually later.'
			);
