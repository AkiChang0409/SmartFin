...
type OcrLikeExtract = {
	/** From {@link runOcrPipeline} first pass — issue / transaction date, any voucher type */
...
- This is the DOCUMENT / transaction date on this PO, invoice, or receipt — when the expense was incurred or the document was issued.
